...
CREATE TABLE `historia` (
  ...
  `genero` varchar(100) CHARACTER SET latin1 NOT NULL,
  `rating` varchar(45) CHARACTER SET latin1 DEFAULT NULL,
...
INSERT INTO `historia` VALUES (1,'El Origen','Terror','5','En un bosque habia un no se que pero es terrorífico asi que fijate ...','elOrigen.jpg');
